...
public class AnyStateTransitionHandlerTests
{
    [Theory]
    ...
    public void Test_AddAnyTransition(string currentState, bool constraint, string expected)
    {
        ...
        var builder = SequenceBuilder.Configure(builder =>
        {
            ...
            builder.AddTransition("Force", "State1", () => false);
            builder.AddTransition("State1", "State2", () => false);
            builder.AddTransition("State2", "State3", () => false);
            builder.AddTransition("State3", "Force", () => false);
            builder.AddTransition("StateX", "Force", () => false);
